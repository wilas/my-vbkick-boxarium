...
# Static net - not working...
#sed -i '' 's/\"ip\": \"dhcp\",/\"ip\": \"10.0.2.15\",\"netmask\": \"255.255.255.0\",\"gateway\": \"10.0.2.2\",/g' $PTH/prepare-smartos-box.sh
...
#########
#wget -P $PTH -r -nH -nd --no-parent --reject "index.html*" http://dlc-int.openindiana.org/aszeszo/vagrant/scripts/tools/
